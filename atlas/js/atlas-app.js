...
(() => {
  ...
  function openSettings(){
    ...
    $('#setSeMin').value=state.settings.seMin;
    $('#setSeMax').value=state.settings.seMax;
    $('#setRespMin').value=state.settings.respMin;
    $('#setRespGoal').value=state.settings.respGoal;
    $('#setAppsScript').value=state.settings.appsScriptUrl||auth.serverUrl||'';
  ...
  function saveSettings(){
    ...
    state.settings={
      ...
      respGoal:numeric($('#setRespGoal').value),
      matrixCsvUrl:'',
      databaseCsvUrl:'',
