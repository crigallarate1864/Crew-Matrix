...
export function submitVolunteerProposal({url,token,hole,solutionId}){
  return postAppsScriptJson(url,{action:'submitVolunteerProposal',token,hole,solutionId},{timeoutMs:45000});
}
