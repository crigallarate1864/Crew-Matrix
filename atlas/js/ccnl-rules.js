export const ABSENCE_CATALOG = Object.freeze({
  ...
  PR36: {label:'Permesso personale recuperabile', category:'ABS', ccnlRef:'Art. 33', annualLimit:'personalPermitAnnualHours', hourlyOnly:true, requiresRecovery:true, autoRecoveryMonths:2, recoveryDueRequired:true},
  PERM: {label:'Permesso generico (storico)', category:'ABS', ccnlRef:'Art. 34'},
  VIS: {label:'Visita / terapia / esame diagnostico', category:'ABS', ccnlRef:'Art. 34 c.4', requiresRecovery:true, recoveryDueRequired:true},
  ...
  RFS: {label:'Recupero festività spettante', category:'RC', ccnlRef:'Art. 29', referenceRequired:true, recoveryDeadlineDays:30},
  RCF: {label:'Recupero festività lavorata (sigla storica)', category:'RC', ccnlRef:'Art. 29', referenceRequired:true, recoveryDeadlineDays:30},
